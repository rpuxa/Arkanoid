...
import static ru.rpuxa.arkanoid.Components.StoreButton.ruby;
import static ru.rpuxa.arkanoid.Components.StoreButton.star;
...
public class MoneyBar implements Child {
    ...
    public MoneyBar(String texturePath, int x, int y, int width, int height, int currency) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
